...
public class BoardArray2D extends AbstractBoard{
	...
	BoardArray2D(){
		System.out.println("Creating a 2D board.");
	}
	...
	public void setSize(int sizeX, int sizeY) {
		...
		array = new int[boardSizeX][boardSizeY];
		reset();	
	...
	public void reset(){
		for(int i=0;i<boardSizeX;i++) {
			for(int j=0;j<boardSizeY;j++){
				array[i][j]=i*boardSizeX+j+1;
			}	
		}
		c1=boardSizeX-1;
		c2=boardSizeY-1;
		
		array[c1][c2]=-1; // -1 means blank tile, c1 and c2 holds blank tile.
	}
